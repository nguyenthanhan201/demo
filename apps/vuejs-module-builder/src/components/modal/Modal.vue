...
<template>
  <teleport to="body">
    <TransitionRoot :show="show" as="template">
      <Dialog as="div" class="fixed z-30 inset-0 overflow-y-auto sm:px-4 py-6 p-4" @close="close">
        <div class="flex items-end justify-center pb-20 text-center sm:block sm:p-0">
          <TransitionChild
            as="template"
