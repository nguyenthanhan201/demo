...
import Unsplash from '../designerMain/editor-menu/media-library-components/Unsplash.vue';
...
export default {
  ...
  setup(props: any, context: any) {
    ...
    //
    //
    const changeSelectedMenuTab = function (clicked: any) {
    ...
    <Dialog as="div" class="fixed z-30 inset-0 overflow-y-auto" @close="firstButton">
      ...
      >
        ...
        >
          ...
          >
            <div class="flex gap-2 justify-between items-center border-b border-gray-200 pb-2">
                    ...
                    <div class="pb-4 max-w-7xl mx-auto">
                      ...
                      <div class="mb-2">
                        ...
                        <div class="hidden sm:block">
                          <div class="flex items-center border border-gray-200 py-1 px-2 rounded">
                            <nav
                  ...
                  <aside class="md:w-72 relative min-h-[62rem] max-h-[62rem]">
                    ...
                    >
                      <div class="pb-6 space-y-6">
                        <div
                          v-if="getHighlightedImage && getHighlightedImage.file !== null"
                          ...
                          <div class="md:px-2 px-2">
                            ...
                            >
                              ...
                              >
                                ...
                                <dd class="text-gray-900">
                                  {{ getHighlightedImage?.imageDetails?.user?.name }}
                                </dd>
                              </div>
