...
<template>
  <Modal :show="show" @close="firstButton" :maxWidth="maxWidth">
      ...
      <div class="flex items-center border-b border-gray-200 pb-2 mb-2">
        <div class="flex-1">
          ...
          <div class="flex gap-2 justify-start items-center">
            ...
            >
              <CheckIcon aria-hidden="true" class="h-4 w-4 text-myPrimaryLinkColor" />
            </div>
            ...
            >
              <BellIcon aria-hidden="true" class="h-4 w-4 text-myPrimaryDarkGrayColor" />
            </div>
    ...
    <div class="bg-gray-100 px-6 py-4 bottom-0 left-0 right-0 flex sm:justify-end justify-center">
      <slot name="footer" />
      <div
        :class="{
