<template>
  ...
  >
    ...
    >
      <p class="myPrimaryTag">Images {{ getUnsplashImages.fetchedMedia.total }}</p>
      <p class="myPrimaryTag">Pages {{ getUnsplashImages.fetchedMedia.total_pages }}</p>
...
const searchUnsplash = function () {
  console.log('👌  getSearchTerm:', getSearchTerm.value);
  if (
