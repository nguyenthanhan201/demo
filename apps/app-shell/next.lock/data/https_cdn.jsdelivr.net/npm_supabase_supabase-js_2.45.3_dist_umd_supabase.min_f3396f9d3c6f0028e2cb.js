 ...
 * Original file: /npm/@supabase/supabase-js@2.45.3/dist/umd/supabase.js
 *
    ...
    var e,
      ...
      i = {
        235: (e, t, s) => {
          s.r(t),
            s.d(t, {
              ...
              AuthClient: () => ne,
              AuthError: () => w,
              AuthImplicitGrantRedirectError: () => x,
              AuthInvalidCredentialsError: () => $,
              AuthInvalidTokenResponseError: () => A,
              AuthPKCEGrantCodeExchangeError: () => C,
              AuthRetryableFetchError: () => R,
              AuthSessionMissingError: () => j,
              AuthUnknownError: () => E,
          ...
          async function _(e, t, s = !1) {
            const r = (function () {
              ...
              return crypto.getRandomValues(e), Array.from(e, m).join('');
            })();
            let i = r;
            s && (i += '/PASSWORD_RECOVERY'), await f(e, `${t}-code-verifier`, i);
          ...
          const b = /^2[0-9]{3}-(0[1-9]|1[0-2])-(0[1-9]|1[0-9]|2[0-9]|3[0-1])$/i;
          ...
          function S(e) {
            return k(e) && 'AuthApiError' === e.name;
          }
          class E extends w {
            constructor(e, t) {
          ...
          function P(e) {
            return k(e) && 'AuthSessionMissingError' === e.name;
          }
          class A extends O {
            constructor() {
          ...
          function I(e) {
            return k(e) && 'AuthRetryableFetchError' === e.name;
          }
          class L extends O {
            constructor(e, t, s) {
          ...
          function U(e) {
            return k(e) && 'AuthWeakPasswordError' === e.name;
          }
          const D = (e) =>
          ...
          async function F(e) {
            var t;
            if (!d(e)) throw new R(D(e), 0);
            if (N.includes(e.status)) throw new R(D(e), e.status);
            let s, r;
            try {
              s = await e.json();
            } catch (e) {
            ...
            if (
              ...
              if ('session_not_found' === r) throw new j();
            } else if (
              'object' == typeof s &&
              s &&
            ...
            throw new T(D(s), e.status || 500, r);
          }
            ...
            const l = Object.keys(c).length ? '?' + new URLSearchParams(c).toString() : '',
              h = await (async function (e, t, s, r, i, n) {
                ...
                try {
                  ...
                  throw (console.error(e), new R(D(e), 0));
                }
            ...
            return (
              ...
              await globalThis.navigator.locks.request(
                ...
                async (r) => {
                  ...
                  Y.debug && console.log('@supabase/gotrue-js: navigatorLock: acquired', e, r.name);
                  try {
                    return await s();
                  } finally {
                    Y.debug &&
          ...
          class re {
            ...
            async _initialize() {
              try {
                const e = !!a() && (await this._isPKCEFlow());
                if (
                  ...
                  if (s)
                    return (
                      ...
                      'Identity is already linked' === (null == s ? void 0 : s.message) ||
                ...
                return k(e)
                  ? { error: e }
                  : { error: new E('Unexpected error during initialization', e) };
              } finally {
            ...
            async signUp(e) {
              ...
              try {
                ...
                if ('email' in e) {
                  ...
                  let o = null,
                    a = null;
                  'pkce' === this.flowType && ([o, a] = await _(this.storage, this.storageKey)),
                  ...
                  if (!('phone' in e))
                    throw new $('You must provide either an email or phone number and a password');
                  {
            ...
            async signInWithPassword(e) {
              try {
                ...
                return r
                  ...
                  : { data: { user: null, session: null }, error: new A() };
              } catch (e) {
                if (k(e)) return { data: { user: null, session: null }, error: e };
                throw e;
              }
            ...
            async _exchangeCodeForSession(e) {
              const t = await p(this.storage, `${this.storageKey}-code-verifier`),
                [s, r] = (null != t ? t : '').split('/');
              try {
                ...
                if ((await g(this.storage, `${this.storageKey}-code-verifier`), i)) throw i;
                return t && t.session && t.user
                  ...
                  : { data: { user: null, session: null, redirectType: null }, error: new A() };
              } catch (e) {
                if (k(e))
            ...
            async signInWithOtp(e) {
              ...
              try {
                if ('email' in e) {
                  ...
                  let n = null,
                    o = null;
                  'pkce' === this.flowType && ([n, o] = await _(this.storage, this.storageKey));
                ...
                throw new $('You must provide either an email or phone number.');
              } catch (e) {
                if (k(e)) return { data: { user: null, session: null }, error: e };
                throw e;
              }
            ...
            async signInWithSSO(e) {
              ...
              try {
                let i = null,
                  n = null;
                return (
                  'pkce' === this.flowType && ([i, n] = await _(this.storage, this.storageKey)),
            ...
            async resend(e) {
              try {
                ...
                throw new $('You must provide either an email or phone number and a type');
              } catch (e) {
                if (k(e)) return { data: { user: null, session: null }, error: e };
                throw e;
              }
            ...
            async __loadSession() {
              ...
              try {
                let e = null;
                const t = await p(this.storage, this.storageKey);
                if (
            ...
            async _updateUser(e, t = {}) {
              try {
                return await this._useSession(async (s) => {
                  ...
                  'pkce' === this.flowType &&
                    null != e.email &&
                    ([o, a] = await _(this.storage, this.storageKey));
            ...
            async _setSession(e) {
              try {
                ...
                if (k(e)) return { data: { session: null, user: null }, error: e };
                throw e;
              }
            }
            ...
            async _refreshSession(e) {
              try {
                return await this._useSession(async (t) => {
                  ...
                  if (!(null == e ? void 0 : e.refresh_token)) throw new j();
                  const { session: r, error: i } = await this._callRefreshToken(e.refresh_token);
                  return i
            ...
            async _getSessionFromURL(e) {
              try {
                ...
                if ('pkce' == this.flowType && !e) throw new C('Not a valid PKCE flow url.');
                const t = h(window.location.href);
                if (e) {
                  if (!t.code) throw new C('No code detected.');
                ...
                if (!(i && o && n && l)) throw new x('No session defined in URL');
                ...
                if (k(e)) return { data: { session: null, redirectType: null }, error: e };
                throw e;
              }
            }
            ...
            async _signOut({ scope: e } = { scope: 'global' }) {
              return await this._useSession(async (t) => {
                ...
                if (n) {
                  ...
                  if (t && (!S(t) || (404 !== t.status && 401 !== t.status && 403 !== t.status)))
                    return { error: t };
                }
                return (
                  'others' !== e &&
            ...
            async resetPasswordForEmail(e, t = {}) {
              let s = null,
                r = null;
              'pkce' === this.flowType && ([s, r] = await _(this.storage, this.storageKey, !0));
              try {
            ...
            async linkIdentity(e) {
              ...
              try {
                ...
                if (k(t)) return { data: { provider: e.provider, url: null }, error: t };
                throw t;
              }
            }
            ...
            async _recoverAndRefresh() {
              ...
              this._debug(t, 'begin');
              try {
                const s = await p(this.storage, this.storageKey);
            ...
            async _callRefreshToken(e) {
              ...
              this._debug(r, 'begin');
              try {
                this.refreshingDeferred = new y();
                const { data: t, error: s } = await this._refreshAccessToken(e);
                if (s) throw s;
                if (!t.session) throw new j();
                await this._saveSession(t.session),
            ...
            async _removeSession() {
              this._debug('#_removeSession()'), await g(this.storage, this.storageKey);
            }
            ...
            async _getUrlForProvider(e, t, s) {
              ...
              if (
                ...
                const [e, t] = await _(this.storage, this.storageKey),
            ...
            async _enroll(e) {
              try {
                return await this._useSession(async (t) => {
                  ...
                  return c
                    ? { data: null, error: c }
                    : ('phone' === e.factorType && delete a.totp,
                      'totp' === e.factorType &&
        ...
        932: (e, t, s) => {
          ...
          const r = { 'X-Client-Info': 'realtime-js/2.10.2' };
          var i, n, o, a, c, l;
          !(function (e) {
          ...
          class A {
            constructor(e, t = { config: {} }, s) {
              (this.topic = e),
                ...
                (this.broadcastEndpointURL = w(this.socket.endPoint) + '/api/broadcast');
            }
            ...
            connect() {
              if (!this.conn)
                if (this.transport)
                  ...
                  if (x)
                    return (
                      (this.conn = new WebSocket(this._endPointURL())), void this.setupConnection()
                    );
                  (this.conn = new R(this._endPointURL(), void 0, {
                    close: () => {
                      this.conn = null;
                    }
                  })),
        ...
        623: (e, t, s) => {
          ...
          const w = { 'X-Client-Info': 'storage-js/2.7.0' };
          ...
          class S extends T {
            ...
            from(e) {
              return new b(this.url, this.headers, e, this.fetch);
            }
          }
        },
        787: function (e, t, s) {
    ...
    return (
      ...
      (o.l = (e, t, i, n) => {
        if (s[e]) s[e].push(t);
          ...
          var d = (t, r) => {
            ...
            f = setTimeout(d.bind(null, void 0, { type: 'timeout', target: a }), 12e4);
      ...
      (() => {
        ...
        if (
          ...
          if (s.length)
            for (var r = s.length - 1; r > -1 && (!e || !/^http(s?):/.test(e)); ) e = s[r--].src;
        }
